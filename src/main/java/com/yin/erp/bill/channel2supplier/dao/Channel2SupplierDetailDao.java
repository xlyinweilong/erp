 ...
 */
@Resource
public interface Channel2SupplierDetailDao extends BaseBillDetailDao<Channel2SupplierDetailPo, String> {

    @Modifying
    @Query("delete from Channel2SupplierDetailPo t where t.billId = :billId")
    @Override
